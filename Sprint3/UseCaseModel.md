...
4. Korisnnik unosi nove podatke
...
# DOURADITI UC-6: Pregled dodijeljenih tiketa 
### Akter:
Tehničar 
### Naziv use casea: 
Pregled vlastitih tiketa 
### Kratak opis:
Tehničar vidi samo svoje tikete 
Preduslovi: Tiketi dodijeljeni 
Glavni tok: 
Tehničar otvara listu 
Sistem prikazuje njegove tikete 
Alternativni tokovi: 
Nema tiketa → poruka 
Ishod: Pregled tiketa 

---

# PROVJERITI ZA PORUKE UC-7. Komunikacija kroz tiket
### Akter:
...
# UC-8 : Pregled i uređivanje korisničkih profila
### Akter :
Administrator
### Naziv use casea :
Pregled i uređivanje korisničkih profila
### Kratak opis : Administrator pregledava i uređuje profile korisnika uz evidentiranje izmjena, bez pristupa lozinkama
### Preduslovi :
...
# UC-13 : Zatvaranje tiketa -> vidjeti kako radi po novom sistemu
