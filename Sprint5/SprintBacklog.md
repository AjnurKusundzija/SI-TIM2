...
| SB-03 | PB-19 Login korisnika (US-1, US-2, US-3) | Uma, Hana, Lamija | Done | Prijava, validacija unosa i kontrola pristupa |
| SB-04 | Unit testovi za autentifikaciju | Lejan, Uma | To Do | Pokriti osnovne i negativne auth scenarije |
| SB-05 | PB-22 Kreiranje novog tiketa (US-8, US-9, US-10) | Hana, Lamija | Done | Forma za prijavu problema, validacija obaveznih polja i spremanje tiketa |
| SB-06 | PB-23 Pregled vlastitih tiketa (US-11, US-12, US-13) | Eldar, Merisa | Done | Lista vlastitih tiketa sa statusom i osnovnim filtriranjem |
| SB-07 | Koordinacija sprint dokumentacije i artefakata | Ajnur Kusundzija | Done | Uskladjivanje Sprint Goal, Sprint Backlog, AI Usage Log i Decision Log |
